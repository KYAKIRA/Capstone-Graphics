...
RTTR_REGISTRATION{
	rttr::registration::class_<Quaternion>("Quaternion")
		...
		.constructor<float, const Vector3&>()
		.constructor<const Vector4&>()
		...
		.method("__add", &Quaternion::operator+)
		.method("__mul", static_cast<Quaternion(Quaternion::*)(const Quaternion&) const>(&Quaternion::operator*))
		.method("__mul", static_cast<Quaternion(Quaternion::*)(const float) const>(&Quaternion::operator*))
		.method("__div", &Quaternion::operator/)
		.method("Dot", &Quaternion::Dot)
		.method("Magnitude", &Quaternion::Magnitude)
		.method("Normalize", static_cast<Quaternion(*)(const Quaternion&)>(&Quaternion::Normalize))
		.method("Normalize", static_cast<void(Quaternion::*)()>(&Quaternion::Normalize))
		.method("Normalized", static_cast<Quaternion(Quaternion::*)() const>(&Quaternion::Normalized))
		.method("Inverse", &Quaternion::Inverse)
		.method("Rotate", &Quaternion::Rotate)
		.method("GetRotationAngle", &Quaternion::GetRotationAngle)
		.method("GetRotationAxis", &Quaternion::GetRotationAxis)
		.method("LookAt", &Quaternion::LookAt)
		.method("Lerp", &Quaternion::Lerp)
		.method("Slerp", &Quaternion::Slerp)
		.method("ToMatrix3", static_cast<Matrix3(Quaternion::*)() const>(&Quaternion::ToMatrix3))
		.method("ToMatrix3", static_cast<Matrix3(*)(const Quaternion&)>(&Quaternion::ToMatrix3))
		.method("ToMatrix4", static_cast<Matrix4(Quaternion::*)() const>(&Quaternion::ToMatrix4))
		.method("ToMatrix4", static_cast<Matrix4(*)(const Quaternion&)>(&Quaternion::ToMatrix4))
		.method("ToEuler", static_cast<Euler(Quaternion::*)() const>(&Quaternion::ToEuler))
		.method("ToEuler", static_cast<Euler(*)(const Quaternion&)>(&Quaternion::ToEuler))
...
Quaternion::Quaternion(const aiQuaternion& q_) : w(q_.w), x(q_.x), y(q_.y), z(q_.z){
}
...
Quaternion Quaternion::LookAt(const Vector3& source_, const Vector3& destination_){
	...
	float dot = Vector3::Dot(Transform::worldForward, forwardVector);

	if(Math::Abs(dot - (-1.0f)) < Math::NearZero()){
		return Quaternion(Math::PI(), Transform::worldUp);
	}
	...
	Vector3 rotAxis = Vector3::Cross(Transform::worldForward, forwardVector).Normalized();
