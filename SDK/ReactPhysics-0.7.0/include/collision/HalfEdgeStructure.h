...
class HalfEdgeStructure {
    ...
    public:
        ...
        struct Face {
            ...
            /// Constructor
            Face(List<uint> vertices) : edgeIndex(0), faceVertices(vertices) {}
        };
        ...
        struct Vertex {
            ...
            /// Constructor
            Vertex(uint vertexCoordsIndex) : vertexPointIndex(vertexCoordsIndex), edgeIndex(0) { }
        };
...
inline uint HalfEdgeStructure::addVertex(uint vertexPointIndex) {
    ...
    return static_cast<uint>(mVertices.size() - 1);
}
