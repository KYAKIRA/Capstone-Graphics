...
class Map {
    ...
    private:
        ...
        struct Entry {
            ...
            /// Constructor
            Entry() : hashCode(0), next(-1), keyValue(nullptr){
            }

            /// Constructor
            Entry(size_t hashcode, int nextEntry) : hashCode(hashCode), next(nextEntry), keyValue(nullptr){
            }

            /// Copy-constructor
            Entry(const Entry& entry) : hashCode(entry.hashCode), next(entry.next), keyValue(entry.keyValue){
            }
    ...
    public:
        ...
        Map(MemoryAllocator& allocator, size_t capacity = 0)
            ...
            if (capacity > 0) {
               ...
               initialize(static_cast<int>(capacity));
            }
        }
        ...
        void add(const Pair<K,V>& keyValue, bool insertIfAlreadyPresent = false) {
            ...
            mBuckets[bucket] = static_cast<uint>(entryIndex);
        }
