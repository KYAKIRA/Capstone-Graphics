...
class Set {
    ...
    private:
        ...
        struct Entry {
            ...
            /// Constructor
            Entry() : hashCode(0), next(-1), value(nullptr){
            }

            /// Constructor
            Entry(size_t hashcode, int nextEntry) : hashCode(hashCode), next(nextEntry), value(nullptr){
            }

            /// Copy-constructor
            Entry(const Entry& entry) : hashCode(entry.hashCode), next(entry.next), value(entry.value){
            }
    ...
    public:
        ...
        void add(const V& value) {
            ...
            mBuckets[bucket] = static_cast<int>(entryIndex);
        }
