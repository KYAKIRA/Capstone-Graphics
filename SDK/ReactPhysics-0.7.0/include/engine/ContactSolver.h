...
class ContactSolver {
    ...
    private:
        ...
        struct ContactPointSolver {
			ContactPointSolver() : externalContact(nullptr), normal(), r1(), r2(), penetrationDepth(), restitutionBias(), penetrationImpulse(), penetrationSplitImpulse(), inversePenetrationMass(), i1TimesR1CrossN(), i2TimesR2CrossN(), isRestingContact(){
			}
